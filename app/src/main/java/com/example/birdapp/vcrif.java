...
public class vcrif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vcrif);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Victoria's riflebird";
                ...
                Intent intent = new Intent(vcrif.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new vcrif.ScaleListener());
