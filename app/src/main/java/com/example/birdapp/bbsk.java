...
public class bbsk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bbsk);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Black-billed sicklebill";
                ...
                Intent intent = new Intent(bbsk.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new bbsk.ScaleListener());
