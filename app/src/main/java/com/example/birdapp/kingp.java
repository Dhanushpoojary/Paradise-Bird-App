...
public class kingp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kingp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "king bird-of-paradise";
                ...
                Intent intent = new Intent(kingp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new kingp.ScaleListener());
