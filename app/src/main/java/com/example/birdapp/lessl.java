...
public class lessl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lessl);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Lesser lophorina";
                ...
                Intent intent = new Intent(lessl.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new lessl.ScaleListener());
