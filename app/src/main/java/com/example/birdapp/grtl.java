...
public class grtl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Greater lophorina";
                ...
                Intent intent = new Intent(grtl.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new grtl.ScaleListener());
