...
public class arfak extends AppCompatActivity {
    ...
    private ScaleGestureDetector scaleGestureDetector;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_arfak);
            ...
            activityButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String birdName = "Arfak astrapia";
                    ...
                    Intent intent = new Intent(arfak.this,MainActivity.class);
            ...
            scaleGestureDetector = new ScaleGestureDetector(this, new arfak.ScaleListener());
