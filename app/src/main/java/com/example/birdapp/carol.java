...
public class carol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carol);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Carola's parotia";
                ...
                Intent intent = new Intent(carol.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new carol.ScaleListener());
