...
public class goldp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goldp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Goldie's bird-of-paradise";
                ...
                Intent intent = new Intent(goldp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new goldp.ScaleListener());
