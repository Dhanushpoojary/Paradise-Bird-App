...
public class grtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grtp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Greater bird-of-paradise";
                ...
                Intent intent = new Intent(grtp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new grtp.ScaleListener());
