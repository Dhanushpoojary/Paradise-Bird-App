...
public class blsk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blsk);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = " Black sicklebill";
                ...
                Intent intent = new Intent(blsk.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new blsk.ScaleListener());
