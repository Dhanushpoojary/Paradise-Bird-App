...
public class prif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prif);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Paradise riflebird";
                ...
                Intent intent = new Intent(prif.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new prif.ScaleListener());
