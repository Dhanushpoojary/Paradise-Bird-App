...
public class grwrif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grwrif);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Growling riflebird";
                ...
                Intent intent = new Intent(grwrif.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new grwrif.ScaleListener());
