...
public class splend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splend);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Stephanie's astrapia";
                ...
                Intent intent = new Intent(splend.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new splend.ScaleListener());
