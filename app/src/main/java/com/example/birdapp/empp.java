...
public class empp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Emperor bird-of-paradise";
                ...
                Intent intent = new Intent(empp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new empp.ScaleListener());
