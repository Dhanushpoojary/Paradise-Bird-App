...
public class kings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "King of Saxony bird-of-paradise";
                ...
                Intent intent = new Intent(kings.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new kings.ScaleListener());
