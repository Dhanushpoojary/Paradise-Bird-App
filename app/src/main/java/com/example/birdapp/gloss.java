...
public class gloss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gloss);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Glossy-mantled manucode";
                ...
                Intent intent = new Intent(gloss.this,MainActivity.class);
