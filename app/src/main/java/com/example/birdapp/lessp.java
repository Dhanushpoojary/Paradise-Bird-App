...
public class lessp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lessp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Lesser bird-of-paradise";
                ...
                Intent intent = new Intent(lessp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new lessp.ScaleListener());
