...
public class rib extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(rib.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new rib.ScaleListener());
