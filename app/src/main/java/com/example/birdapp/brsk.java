...
public class brsk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brsk);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Brown sicklebill";
                ...
                Intent intent = new Intent(brsk.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new brsk.ScaleListener());
