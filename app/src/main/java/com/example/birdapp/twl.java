...
public class twl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twl);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Twelve-wired bird-of-paradise";
                ...
                Intent intent = new Intent(twl.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new twl.ScaleListener());
