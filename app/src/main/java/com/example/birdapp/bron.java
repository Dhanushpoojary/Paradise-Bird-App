...
public class bron extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Bronze parotia";
                ...
                Intent intent = new Intent(bron.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new bron.ScaleListener());
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            scaleFactor = Math.max(10.f, Math.min(scaleFactor, 10.0f)); // Limit scale factor to desired range
