    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Magnificent bird-of-paradise";
                ...
                Intent intent = new Intent(mag.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new mag.ScaleListener());
