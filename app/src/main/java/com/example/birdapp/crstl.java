...
public class crstl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crstl);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Crescent-caped lophorina";
                ...
                Intent intent = new Intent(crstl.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new crstl.ScaleListener());
