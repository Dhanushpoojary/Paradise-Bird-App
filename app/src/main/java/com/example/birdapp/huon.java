...
public class huon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_huon);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(huon.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new huon.ScaleListener());
