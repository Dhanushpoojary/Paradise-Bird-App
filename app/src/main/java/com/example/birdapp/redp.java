...
public class redp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_redp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Red bird-of-paradise";
                ...
                Intent intent = new Intent(redp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new redp.ScaleListener());
