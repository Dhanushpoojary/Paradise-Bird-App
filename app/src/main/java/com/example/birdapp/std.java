    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Standardwing bird-of-paradise";
                ...
                Intent intent = new Intent(std.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new std.ScaleListener());
