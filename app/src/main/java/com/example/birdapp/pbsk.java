...
public class pbsk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pbsk);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Pale-billed sicklebill";
                ...
                Intent intent = new Intent(pbsk.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new pbsk.ScaleListener());
