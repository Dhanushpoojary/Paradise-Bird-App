...
public class wah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wah);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Wahnes's parotia";
                ...
                Intent intent = new Intent(wah.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new wah.ScaleListener());
