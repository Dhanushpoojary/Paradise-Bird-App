...
public class mgrif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mgrif);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Magnificent riflebird";
                ...
                Intent intent = new Intent(mgrif.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new mgrif.ScaleListener());
