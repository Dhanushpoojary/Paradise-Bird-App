...
public class ragp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ragp);
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "Raggiana bird-of-paradise";
                ...
                Intent intent = new Intent(ragp.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new ragp.ScaleListener());
