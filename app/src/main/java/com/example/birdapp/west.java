    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String birdName = "western or Arfak parotia";
                ...
                Intent intent = new Intent(west.this,MainActivity.class);
        ...
        scaleGestureDetector = new ScaleGestureDetector(this, new west.ScaleListener());
